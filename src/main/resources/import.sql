...
INSERT INTO Repair ("date", state, repair_type, cost, address, user_id, description) VALUES (getDate(), 'DONE', 'FRAMES', 2500, '', 3, '9 Windows');
INSERT INTO Repair ("date", state, repair_type, cost, address, user_id, description) VALUES (getDate(), 'WAITING', 'PLUMBING', 300, 'asdasd', 4, 'Bathroom');
INSERT INTO Repair ("date", state, repair_type, cost, address, user_id, description) VALUES (getDate(), 'ONGOING', 'ELECTRICAL_WORK', 150, 'asdasd', 5, 'Electric Sockets');
INSERT INTO Repair ("date", state, repair_type, cost, address, user_id, description) VALUES (getDate(), 'DONE', 'ELECTRICAL_WORK', 1000, 'asdasd', 6, 'New sockets & switches for the whole house');